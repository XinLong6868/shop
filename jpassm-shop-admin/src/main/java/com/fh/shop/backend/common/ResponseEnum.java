...
public enum ResponseEnum {
	...
	API_SECURITY_HEADER_MISS(3001,"头信息丢失"),
	API_SECURITY_REQUEST_EXPIRE(3002,"请求超时"),
	API_SECURITY_ATTACK(3003,"接口被攻击了"),
	API_SECURITY_APPKEY_ERROR(3004,"appkey无效"),
	API_SECURITY_APPSECRET_ERROR(3005,"签名错误"),
	API_SECURITY_LIMIT(3006,"接口限流"),
