            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        地区管理
                        <button type="button" class="btn btn-success animated bounceInLeft" onclick="addArea();"><span
                                class="glyphicon glyphicon-plus"></span> 新增
                        </button>
                        <button type="reset" class="btn btn-warning animated bounceInLeft" onclick="updateArea();"><span
                                class="glyphicon glyphicon-pencil"></span> 修改
                        </button>
                        <button type="reset" class="btn btn-danger animated bounceInLeft" onclick="deleteArea();"><span
