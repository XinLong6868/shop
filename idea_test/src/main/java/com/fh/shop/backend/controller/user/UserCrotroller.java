...
public class UserCrotroller {
    ...
    @RequestMapping("user/tolistUserInfo")
    public String tolistUserInfo() {
     ...
     * @return</pre>
     */
    @RequestMapping("user/listUserInfo")
    @ResponseBody
    public ServerResponse listUserInfo(UserInfo userInfo){

        return ServerResponse.success(iUserService.findUserList(userInfo));
    }
