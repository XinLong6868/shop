...
<body>
<script type="text/javascript" src="<%=request.getContextPath()%>/html/js/jquery-3.3.1.min.js"></script>
...
<form class="form-horizontal">
    <div class="col-sm-12" align="center">
        <div class="alert alert-info" role="alert">
            <h1 class="animated infinite swing">Login Page</h1>
        </div>
    </div>
    <div class="alert alert-success" role="alert" style="height: 700px;">
        ...
        <div class="form-group">
            <label for="userName" class="col-sm-4 control-label animated bounce delay-1s">userName</label>
            <div class="col-sm-8">
                <input type="text" style="width: 500px;" class="form-control" id="userName" placeholder="Name">
            </div>
        </div>
        <div class="form-group">
            <label for="userPwd" class="col-sm-4 control-label animated bounce delay-2s">Password</label>
            <div class="col-sm-8">
        ...
        <div class="form-group">
            <label for="imgCode" class="col-sm-4 control-label animated bounce delay-3s">ImgCode</label>
            <div class="col-sm-8">
                <div class="col-sm-2">
        ...
        <div class="form-group" align="center">
            <div class="col-sm-offset-5 col-sm-2">
                <button type="button" class="btn btn-success animated bounceInLeft" onclick="userLogin();">Sign in</button>
                <button type="reset" class="btn btn-warning animated bounceInRight">Reset</button>
            </div>
        </div>
    </div>
</form>
