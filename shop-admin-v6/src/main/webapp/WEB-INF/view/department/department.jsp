        ...
        <div class="collapse navbar-collapse" id="bs-productTable-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu animated bounceInDown faster">
...
<fieldset style="margin-top: 50px; text-align: center;">
    <legend>
        <h3 class="lead animated fadeInDown slow">
            亲爱的用户：
...
<div class="container" style="width: 100%; margin-top: -20px;">
    <div class="row">
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        部门管理
                        <button type="button" class="btn btn-success animated bounceInLeft" onclick="addDept();"><span
                                class="glyphicon glyphicon-plus"></span> 新增
                        </button>
                        <button type="reset" class="btn btn-warning animated bounceInLeft" onclick="updateDept();"><span
                                class="glyphicon glyphicon-pencil"></span> 修改
                        </button>
                        <button type="reset" class="btn btn-danger animated bounceInLeft" onclick="deleteDept();"><span
                                class="glyphicon glyphicon-trash"></span> 删除
                        </button>
                    </h3>
                </div>
                <div class="panel-body">
                    <div class="content_wrap animated flipInX fast">
        ...
        <div class="col-md-9 animated bounceInRight">
            <div id="firstJsp">
                <div class="col-md-12">
                    ...
                    <button type="button" class="btn btn-info animated bounceInRight" onclick="addUser();"><span
                            class="glyphicon glyphicon-plus"></span> 新增
                    </button>
                    <button type="button" class="btn btn-warning animated bounceInRight" onclick="updateUser();"><span
                            class="glyphicon glyphicon-pencil"></span> 修改
                    </button>
                    <button type="button" class="btn btn-danger animated bounceInRight" onclick="deleteUser();"><span
                            class="glyphicon glyphicon-trash"></span> 删除
                    </button>
                    <button type="button" class="btn btn-info animated bounceInRight" onclick="deptExcelOut();"><span
                            class="glyphicon glyphicon-open"></span> 按部门Excel导出
                    </button>
                    <button type="button" class="btn btn-info animated bounceInRight" onclick="updateDeptAll();"><span
                                ...
                                success: function (data) {
                                    if (data.code == 200) {
                                        bootbox.alert({
                                            title: "提示信息",
                                            message: '部门添加成功',
                                            className: 'animated lightSpeedIn faster',
                                        });
                                        var newNode = {
                                            id: data.data,
                                            name: $("#deptName").val(),
