...
public class TencentCOS {
    ...
    public static void SimpleUploadFileFromStream(File file, String fileName) {
        ...
        COSCredentials cred = new BasicCOSCredentials("AKIDB8sUwJLQRSRChxR8AWgl7AyFJMKlnB6t", "gYDdpmVdWBbmkWlvxvxeFwWsfKtLyQjJ");
    ...
    public static String uploadFile(File file,String fileName) {
        ...
        COSClient cosclient = new COSClient(cred, clientConfig);
        // bucket名需包含appid
        String bucketName = "image-cloud-1258857844";
        ...
        cosclient.shutdown();
        return "https://image-cloud-1258857844.cos.ap-beijing.myqcloud.com/"+key;
    }
